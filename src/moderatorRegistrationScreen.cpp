...
ModeratorRegistrationScreen::ModeratorRegistrationScreen(Screen &screen)
    : currentScreen(screen), usernameInput(""), emailInput(""), passwordInput(""), registrationSuccess(false), currentFocus(0) {}

void ModeratorRegistrationScreen::update()
{
    handleInput();
}

void ModeratorRegistrationScreen::draw()
{
    ClearBackground(RAYWHITE);

    DrawText("Register New Moderator", 50, 50, 24, BLACK);
    ...
    {
        DrawText("Moderator registered successfully!", 50, 350, 20, GREEN);
    }
}

void ModeratorRegistrationScreen::handleInput()
{
...
void ModeratorRegistrationScreen::registerModerator()
{
